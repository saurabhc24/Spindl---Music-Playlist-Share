...
export default async function ClaimUsernamePage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 justify-center px-6 py-10 [@media(min-height:640px)]:items-center sm:py-16">
        <div className="w-full max-w-md">
          <h1 className="heading text-3xl">Pick your link</h1>
          <p className="mt-2 text-sm text-ink-dim">
            This is where people will find your playlists. You can change it
            later in settings.
          </p>
